...
/usr/OV/bin/addtrap -l apcK           -n APC -i 1.3.6.1.4.1.318 -g 6 -o A -s 580 -t 4 -S 4 -c "Status Events" -f - -F "Key override unlock has occurred on door %s. Host: %s."
...
/usr/OV/bin/addtrap -l atsLowLoad     -n APC -i 1.3.6.1.4.1.318 -g 6 -o A -s 638 -t 3 -S 2 -c "Status Events" -f - -F "ATS has violated the bank or phase low load threshold. Host: %s."
/usr/OV/bin/addtrap -l atsLdClred     -n APC -i 1.3.6.1.4.1.318 -g 6 -o A -s 639 -t 2 -S 0 -c "Status Events" -f - -F "The low load condition on an ATS has been cleared. Host: %s."
/usr/OV/bin/addtrap -l atsNrOvd       -n APC -i 1.3.6.1.4.1.318 -g 6 -o A -s 640 -t 3 -S 2 -c "Status Events" -f - -F "ATS is near a bank or phase overload condition. Host: %s."
/usr/OV/bin/addtrap -l atsNrOvdClred  -n APC -i 1.3.6.1.4.1.318 -g 6 -o A -s 641 -t 2 -S 0 -c "Status Events" -f - -F "ATS bank or phase near overload condition has cleared. Host: %s."
/usr/OV/bin/addtrap -l atsOverload    -n APC -i 1.3.6.1.4.1.318 -g 6 -o A -s 642 -t 4 -S 4 -c "Status Events" -f - -F "ATS is in overload condition. Host: %s."
/usr/OV/bin/addtrap -l atsOdClred     -n APC -i 1.3.6.1.4.1.318 -g 6 -o A -s 643 -t 2 -S 0 -c "Status Events" -f - -F "The bank or phase overload condition on an ATS has cleared. Host: %s."
/usr/OV/bin/addtrap -l atsRge         -n APC -i 1.3.6.1.4.1.318 -g 6 -o A -s 644 -t 4 -S 4 -c "Status Events" -f - -F "Overvoltage condition violated. Host: %s."
/usr/OV/bin/addtrap -l atsRgeCred     -n APC -i 1.3.6.1.4.1.318 -g 6 -o A -s 645 -t 2 -S 0 -c "Status Events" -f - -F "Overvoltage condition cleared. Host: %s."
/usr/OV/bin/addtrap -l atsRge         -n APC -i 1.3.6.1.4.1.318 -g 6 -o A -s 646 -t 4 -S 4 -c "Status Events" -f - -F "Undervoltage condition violated. Host: %s."
/usr/OV/bin/addtrap -l atsRgeCred     -n APC -i 1.3.6.1.4.1.318 -g 6 -o A -s 647 -t 2 -S 0 -c "Status Events" -f - -F "Undervoltage condition cleared. Host: %s."
/usr/OV/bin/addtrap -l atsR           -n APC -i 1.3.6.1.4.1.318 -g 6 -o A -s 648 -t 4 -S 4 -c "Status Events" -f - -F "OverFrequency condition violated. Host: %s."
/usr/OV/bin/addtrap -l atsRred        -n APC -i 1.3.6.1.4.1.318 -g 6 -o A -s 649 -t 2 -S 0 -c "Status Events" -f - -F "OverFrequency condition cleared. Host: %s."
/usr/OV/bin/addtrap -l atsR           -n APC -i 1.3.6.1.4.1.318 -g 6 -o A -s 650 -t 4 -S 4 -c "Status Events" -f - -F "UnderFrequency condition violated. Host: %s."
/usr/OV/bin/addtrap -l atsRred        -n APC -i 1.3.6.1.4.1.318 -g 6 -o A -s 651 -t 2 -S 0 -c "Status Events" -f - -F "UnderFrequency condition cleared. Host: %s."
/usr/OV/bin/addtrap -l isxrDi         -n APC -i 1.3.6.1.4.1.318 -g 6 -o A -s 652 -t 4 -S 4 -c "Status Events" -f - -F "Communication lost with distribution modules %s. Host: %s."
/usr/OV/bin/addtrap -l isxrDibli      -n APC -i 1.3.6.1.4.1.318 -g 6 -o A -s 653 -t 2 -S 0 -c "Status Events" -f - -F "Communication restored with distribution modules %s. Host: %s."
/usr/OV/bin/addtrap -l isxrDi         -n APC -i 1.3.6.1.4.1.318 -g 6 -o A -s 654 -t 2 -S 0 -c "Status Events" -f - -F "Distribution module inserted into module location %i. Host: %s."
/usr/OV/bin/addtrap -l isxrDi         -n APC -i 1.3.6.1.4.1.318 -g 6 -o A -s 655 -t 2 -S 0 -c "Status Events" -f - -F "Distribution module removed from module location %i. Host: %s."
/usr/OV/bin/addtrap -l isxrBrkerrm    -n APC -i 1.3.6.1.4.1.318 -g 6 -o A -s 656 -t 4 -S 4 -c "Status Events" -f - -F "Distribution breaker open alarm. Module %i, breaker(s) %i - %s. Host: %s."
/usr/OV/bin/addtrap -l isxrBrkerrmCre -n APC -i 1.3.6.1.4.1.318 -g 6 -o A -s 657 -t 2 -S 0 -c "Status Events" -f - -F "Distribution breaker open alarm cleared. Module %i, breaker(s) %i - %s. Host: %s."
/usr/OV/bin/addtrap -l isxrMitio      -n APC -i 1.3.6.1.4.1.318 -g 6 -o A -s 658 -t 4 -S 4 -c "Status Events" -f - -F "Distribution current is below the critical threshold of %s. Module %i.L%i - . Host: %s."
/usr/OV/bin/addtrap -l isxrMitiored   -n APC -i 1.3.6.1.4.1.318 -g 6 -o A -s 659 -t 2 -S 0 -c "Status Events" -f - -F "Distribution current is no longer below the critical threshold. Module %i.L%i - %s. Host: %s."
/usr/OV/bin/addtrap -l isxrLotio      -n APC -i 1.3.6.1.4.1.318 -g 6 -o A -s 660 -t 3 -S 2 -c "Status Events" -f - -F "Distribution current is below the warning threshold of %s. Module %i.L%i - . Host: %s."
/usr/OV/bin/addtrap -l isxrLotiored   -n APC -i 1.3.6.1.4.1.318 -g 6 -o A -s 661 -t 2 -S 0 -c "Status Events" -f - -F "Distribution current is no longer below the warning threshold. Module %i.L%i - %s. Host: %s."
/usr/OV/bin/addtrap -l isxrHitio      -n APC -i 1.3.6.1.4.1.318 -g 6 -o A -s 662 -t 3 -S 2 -c "Status Events" -f - -F "Distribution current is above the warning threshold of %s. Module %i.L%i - . Host: %s."
/usr/OV/bin/addtrap -l isxrHitiored   -n APC -i 1.3.6.1.4.1.318 -g 6 -o A -s 663 -t 2 -S 0 -c "Status Events" -f - -F "Distribution current is no longer above the warning threshold. Module %i.L%i - %s. Host: %s."
/usr/OV/bin/addtrap -l isxrMaxCutio   -n APC -i 1.3.6.1.4.1.318 -g 6 -o A -s 664 -t 4 -S 4 -c "Status Events" -f - -F "Distribution current is above the critical threshold of %s. Module %i.L%i - . Host: %s."
/usr/OV/bin/addtrap -l isxrMaxCutiore -n APC -i 1.3.6.1.4.1.318 -g 6 -o A -s 665 -t 2 -S 0 -c "Status Events" -f - -F "Distribution current is no longer above the critical threshold. Module %i.L%i - %s. Host: %s."
/usr/OV/bin/addtrap -l isxrSukerrm    -n APC -i 1.3.6.1.4.1.318 -g 6 -o A -s 666 -t 4 -S 4 -c "Status Events" -f - -F "Distribution subfeed %i breaker open alarm - %i. Host: %s."
/usr/OV/bin/addtrap -l isxrSukerrmCre -n APC -i 1.3.6.1.4.1.318 -g 6 -o A -s 667 -t 2 -S 0 -c "Status Events" -f - -F "Distribution subfeed %i breaker open alarm cleared - %i. Host: %s."
/usr/OV/bin/addtrap -l isxrSutio      -n APC -i 1.3.6.1.4.1.318 -g 6 -o A -s 668 -t 4 -S 4 -c "Status Events" -f - -F "Distribution subfeed %i.L%i current is below the critical threshold of %s - . Host: %s."
/usr/OV/bin/addtrap -l isxrSutiored   -n APC -i 1.3.6.1.4.1.318 -g 6 -o A -s 669 -t 2 -S 0 -c "Status Events" -f - -F "Distribution subfeed %i.L%i current is no longer below the critical threshold - %s. Host: %s."
/usr/OV/bin/addtrap -l isxrSutio      -n APC -i 1.3.6.1.4.1.318 -g 6 -o A -s 670 -t 3 -S 2 -c "Status Events" -f - -F "Distribution subfeed %i.L%i current is below the warning threshold of %s - . Host: %s."
/usr/OV/bin/addtrap -l isxrSutiored   -n APC -i 1.3.6.1.4.1.318 -g 6 -o A -s 671 -t 2 -S 0 -c "Status Events" -f - -F "Distribution subfeed %i.L%i current is no longer below the warning threshold - %s. Host: %s."
/usr/OV/bin/addtrap -l isxrSutio      -n APC -i 1.3.6.1.4.1.318 -g 6 -o A -s 672 -t 3 -S 2 -c "Status Events" -f - -F "Distribution subfeed %i.L%i current is above the warning threshold of %s - . Host: %s."
/usr/OV/bin/addtrap -l isxrSutiored   -n APC -i 1.3.6.1.4.1.318 -g 6 -o A -s 673 -t 2 -S 0 -c "Status Events" -f - -F "Distribution subfeed %i.L%i current is no longer above the warning threshold - %s. Host: %s."
/usr/OV/bin/addtrap -l isxrSuxCutio   -n APC -i 1.3.6.1.4.1.318 -g 6 -o A -s 674 -t 4 -S 4 -c "Status Events" -f - -F "Distribution subfeed %i.L%i current is above the critical threshold of %s - . Host: %s."
/usr/OV/bin/addtrap -l isxrSuxCutiore -n APC -i 1.3.6.1.4.1.318 -g 6 -o A -s 675 -t 2 -S 0 -c "Status Events" -f - -F "Distribution subfeed %i.L%i current is no longer above the critical threshold - %s. Host: %s."
/usr/OV/bin/addtrap -l isxrTolOutio   -n APC -i 1.3.6.1.4.1.318 -g 6 -o A -s 676 -t 4 -S 4 -c "Status Events" -f - -F "Distribution total current on phase L%i is below the critical threshold of %i. Host: %s."
/usr/OV/bin/addtrap -l isxrTolOutiore -n APC -i 1.3.6.1.4.1.318 -g 6 -o A -s 677 -t 2 -S 0 -c "Status Events" -f - -F "Distribution total current on phase L%i is no longer below the critical threshold. Host: %s."
/usr/OV/bin/addtrap -l isxrTolOutio   -n APC -i 1.3.6.1.4.1.318 -g 6 -o A -s 678 -t 3 -S 2 -c "Status Events" -f - -F "Distribution total current on phase L%i is below the warning threshold of %i. Host: %s."
/usr/OV/bin/addtrap -l isxrTolOutiore -n APC -i 1.3.6.1.4.1.318 -g 6 -o A -s 679 -t 2 -S 0 -c "Status Events" -f - -F "Distribution total current on phase L%i is no longer below the warning threshold. Host: %s."
/usr/OV/bin/addtrap -l isxrTolOutio   -n APC -i 1.3.6.1.4.1.318 -g 6 -o A -s 680 -t 3 -S 2 -c "Status Events" -f - -F "Distribution total current on phase L%i is above the warning threshold of %i. Host: %s."
/usr/OV/bin/addtrap -l isxrTolOutiore -n APC -i 1.3.6.1.4.1.318 -g 6 -o A -s 681 -t 2 -S 0 -c "Status Events" -f - -F "Distribution total current on phase L%i is no longer above the warning threshold. Host: %s."
/usr/OV/bin/addtrap -l isxrTolOuxThti -n APC -i 1.3.6.1.4.1.318 -g 6 -o A -s 682 -t 4 -S 4 -c "Status Events" -f - -F "Distribution total current on phase L%i is above the critical threshold of %i. Host: %s."
/usr/OV/bin/addtrap -l isxrTolOuxThti -n APC -i 1.3.6.1.4.1.318 -g 6 -o A -s 683 -t 2 -S 0 -c "Status Events" -f - -F "Distribution total current on phase L%i is no longer above the critical threshold. Host: %s."
/usr/OV/bin/addtrap -l isxrOugeMtio   -n APC -i 1.3.6.1.4.1.318 -g 6 -o A -s 684 -t 4 -S 4 -c "Status Events" -f - -F "Distribution output voltage on phase L%i is below the critical threshold of %i. Host: %s."
/usr/OV/bin/addtrap -l isxrOugeMtiore -n APC -i 1.3.6.1.4.1.318 -g 6 -o A -s 685 -t 2 -S 0 -c "Status Events" -f - -F "Distribution output voltage on phase L%i is no longer below the critical threshold. Host: %s."
/usr/OV/bin/addtrap -l isxrOugeLtio   -n APC -i 1.3.6.1.4.1.318 -g 6 -o A -s 686 -t 3 -S 2 -c "Status Events" -f - -F "Distribution output voltage on phase L%i is below the warning threshold of %i. Host: %s."
/usr/OV/bin/addtrap -l isxrOugeLtiore -n APC -i 1.3.6.1.4.1.318 -g 6 -o A -s 687 -t 2 -S 0 -c "Status Events" -f - -F "Distribution output voltage on phase L%i is no longer below the warning threshold. Host: %s."
/usr/OV/bin/addtrap -l isxrOugeHtio   -n APC -i 1.3.6.1.4.1.318 -g 6 -o A -s 688 -t 3 -S 2 -c "Status Events" -f - -F "Distribution output voltage on phase L%i is above the warning threshold of %i. Host: %s."
/usr/OV/bin/addtrap -l isxrOugeHtiore -n APC -i 1.3.6.1.4.1.318 -g 6 -o A -s 689 -t 2 -S 0 -c "Status Events" -f - -F "Distribution output voltage on phase L%i is no longer above the warning threshold. Host: %s."
/usr/OV/bin/addtrap -l isxrOugeMxThti -n APC -i 1.3.6.1.4.1.318 -g 6 -o A -s 690 -t 4 -S 4 -c "Status Events" -f - -F "Distribution output voltage on phase L%i is above the critical threshold of %i. Host: %s."
/usr/OV/bin/addtrap -l isxrOugeMxThti -n APC -i 1.3.6.1.4.1.318 -g 6 -o A -s 691 -t 2 -S 0 -c "Status Events" -f - -F "Distribution output voltage on phase L%i is no longer above the critical threshold. Host: %s."
/usr/OV/bin/addtrap -l apcD           -n APC -i 1.3.6.1.4.1.318 -g 6 -o A -s 692 -t 4 -S 4 -c "Status Events" -f - -F "%i door closed improperly. Host: %s."
/usr/OV/bin/addtrap -l apcDred        -n APC -i 1.3.6.1.4.1.318 -g 6 -o A -s 693 -t 2 -S 0 -c "Status Events" -f - -F "%i door no longer closed improperly. Host: %s."
/usr/OV/bin/addtrap -l apcUtio        -n APC -i 1.3.6.1.4.1.318 -g 6 -o A -s 694 -t 4 -S 4 -c "Status Events" -f - -F "%i door user schedule violated. Host: %s."
/usr/OV/bin/addtrap -l apcUtiored     -n APC -i 1.3.6.1.4.1.318 -g 6 -o A -s 695 -t 2 -S 0 -c "Status Events" -f - -F "%i door user schedule violation cleared. Host: %s."
